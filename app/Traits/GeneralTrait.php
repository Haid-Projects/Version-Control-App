...
trait GeneralTrait
{
    ...
    public function returnValidationError($validator,$status_code){
        $response['validator errors']=$validator;
        $response['status code']=$status_code;
    ...
    public function returnError($message,$status_code)    {
    ...
    public function returnErrorException($message,$exception_code,$status_code)
    {
        $response['status']=false;
        $response['exception code']=$exception_code;
        $response['message']=$message;
        $response['status code']=$status_code;
        return response()->json($response,400);
